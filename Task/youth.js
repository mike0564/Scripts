...
function TaskCenter() {
    return new Promise((resolve, reject) => {
        $.post(kdHost('webApi/Nameless/getTaskBrowse?'), async(error, resp, data) => {
            try {
